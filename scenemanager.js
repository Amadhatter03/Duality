class SceneManager {
    ...
    push11(){
        ...
        // Entities
        this.levelEntities[1][1][1].push(new Portal(this.game, 905, 650));
        // World + Boundaries
    ...
    push12(){
        ...
        // Entities
        this.levelEntities[1][2][0].push(new Portal(this.game, 905, 650));
        // World + Boundaries
        ...
        // Entities
        this.levelEntities[1][2][1].push(new Portal(this.game, 905, 650));
        // World + Boundaries
