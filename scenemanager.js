class SceneManager {
    constructor(game) {
        ...
        this.puzzle = 0;
        this.reality = 0;
        this.lastLevel = 2; // The last level
    ...
    loadLevel() {
        ...
        // Ensure the player's position is set correctly for specific levels/puzzles
        if (this.level == 2 && this.puzzle == 1) {
            this.guy.startX = 0;
            this.guy.startY = -20;
        } else if (this.level == 2 && this.puzzle == 2) {
            this.guy.startX = -20;
            this.guy.startY = 372;
        } else {
            this.guy.startX = -32;
    ...
    push12(){
        ...
        this.levelEntities[1][2][0].push(new Portal(this.game, 860, 245));
        ...
        this.levelEntities[1][2][0].push(new KillBox(this.game, 535 + KILLW, 510 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][0].push(new Tile(this.game, 535, 510, "CITY1_TILE1")); //
        this.levelEntities[1][2][0].push(new KillBox(this.game, 300 + KILLW, 480 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][0].push(new Tile(this.game, 300, 480, "CITY1_TILE1")); //
        this.levelEntities[1][2][0].push(new KillBox(this.game, 80 + KILLW, 300 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][0].push(new Tile(this.game, 80, 300, "CITY1_TILE1")); //
        this.levelEntities[1][2][0].push(new KillBox(this.game, 870 + KILLW, 330 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][0].push(new Tile(this.game, 870, 330, "CITY1_TILE1"));
        ...
        this.levelEntities[1][2][0].push(new Coin(this.game, 57, 442));
        // World + Boundaries
        ...
        this.levelEntities[1][2][1].push(new Portal(this.game, 860, 245));
        // Floor tiles
        ...
        this.levelEntities[1][2][1].push(new KillBox(this.game, 190 + KILLW, 400 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][1].push(new Tile(this.game, 190, 400, "CITY2_TILE1"));
        this.levelEntities[1][2][1].push(new KillBox(this.game, 500 + KILLW, 260 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][1].push(new Tile(this.game, 500, 260, "CITY2_TILE1"));
        this.levelEntities[1][2][1].push(new KillBox(this.game, 870 + KILLW, 330 + KILLH, KILLH, KILLH));
        this.levelEntities[1][2][1].push(new Tile(this.game, 870, 330, "CITY2_TILE1"));
    ...
    push20(){
        ...
        this.levelEntities[2][0][0].push(new Coin(this.game, 192, 250));
        this.levelEntities[2][0][0].push(new Coin(this.game,900, 290))
        this.levelEntities[2][0][0].push(new Portal(this.game, 935, 230));
        // World + Boundaries
        this.levelEntities[2][0][0].push(new LeftBoundary(this.game, -10, 0, 10, this.canvasHeight));
        this.levelEntities[2][0][0].push(new RightBoundary(this.game, 1024, 0, 10, this.canvasHeight));
        this.levelEntities[2][0][0].push(new RightBoundary(this.game,815, 318,10, this.canvasHeight));
        ...
        // World + Boundaries
        this.levelEntities[2][0][1].push(new LeftBoundary(this.game, -10, 0, 10, this.canvasHeight));
        this.levelEntities[2][0][1].push(new RightBoundary(this.game, 1024, 0, 10, this.canvasHeight));
        this.levelEntities[2][0][1].push(new RightBoundary(this.game,815, 318,10, this.canvasHeight));
    ...
    push21(){
        // Reality 0
        this.levelEntities[2][1][0].push(new Widget(this.game, 3, 2));
        // Invisible tiles
        ...
        this.levelEntities[2][1][0].push(new Waterfall(this.game, 135, 0, "green"));
        ...
        this.levelEntities[2][1][0].push(new Waterfall(this.game, 475, 430, "green"));
        ...
        this.levelEntities[2][1][0].push(new KillBox(this.game, 0,114, 192,this.canvasHeight));
        this.levelEntities[2][1][0].push(new KillBox(this.game, 490, 576, 192, this.canvasHeight - 576));
        this.levelEntities[2][1][0].push(new KillBox(this.game, 0, this.canvasHeight + 100,1024, 0));
        this.levelEntities[2][1][0].push(new Coin(this.game,924, 652))

        // World + Boundaries
        this.levelEntities[2][1][0].push(new LeftBoundary(this.game, -10, 0, 10, this.canvasHeight));
        this.levelEntities[2][1][0].push(new RightBoundary(this.game, 1024, 0, 10, this.canvasHeight));
        this.levelEntities[2][1][0].push(new RightBoundary(this.game, 480, 576, 10, this.canvasHeight));
        this.levelEntities[2][1][0].push(new RightBoundary(this.game, 690, 75, 10, this.canvasHeight));
        this.levelEntities[2][1][0].push(new LeftBoundary(this.game, 840, 110, 10, this.canvasHeight));
        this.levelEntities[2][1][0].push(new World(this.game, 0, 0, 2, 2));

        // Reality 1

        this.levelEntities[2][1][1].push(new Widget(this.game, 3, 2));
        //Invisible tiles
        this.levelEntities[2][1][1].push(new Tile(this.game,0, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,64, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,128, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,192, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,256, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,320, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,384, 612,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,448, 612,"CITY_TILE1", true));

        this.levelEntities[2][1][1].push(new Tile(this.game, 924, 652,"CITY_TILE1", true));
        this.levelEntities[2][1][1].push(new Tile(this.game,963, 652,"CITY_TILE1", true));
        ...
        // World + Boundaries
        this.levelEntities[2][1][1].push(new LeftBoundary(this.game, -10, 0, 10, this.canvasHeight));
        this.levelEntities[2][1][1].push(new RightBoundary(this.game, 1024, 0, 10, this.canvasHeight));
        this.levelEntities[2][1][1].push(new RightBoundary(this.game, 515, 0, 10, this.canvasHeight));
        this.levelEntities[2][1][1].push(new LeftBoundary(this.game, 770, 0, 10, this.canvasHeight));
    ...
    // Level 2 Puzzle 2
    push22(){
        this.levelEntities[2][2][0].push(new Widget(this.game, 3, 3));
        // Reality 0
        // Invisible tiles
        this.levelEntities[2][2][0].push(new Tile(this.game, 0 , 500, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 64 , 500, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 128 , 500, "CITY_TILE1", true));

        this.levelEntities[2][2][0].push(new Tile(this.game, 384 , 230, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 448 , 230, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 512 , 230, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 548 , 230, "CITY_TILE1", true));

        this.levelEntities[2][2][0].push(new Tile(this.game, 820 , 230, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 884 , 230, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 948 , 230, "CITY_TILE1", true));
        this.levelEntities[2][2][0].push(new Tile(this.game, 1012 , 230, "CITY_TILE1", true));
        // Entities
        this.levelEntities[2][2][0].push(new KillBox(this.game,0, 520,596,this.canvasHeight));
        ...
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 568, 150, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 568, 158, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 568, 202, "green"));
        //this.levelEntities[2][2][0].push(new Grate(this.game, 828, 80, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 828, 80, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 828, 100, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 568, 158, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 568, 202, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 828, 122, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 828, 158, "green"));
        this.levelEntities[2][2][0].push(new Waterfall(this.game, 828, 202, "green"));
        this.levelEntities[2][2][0].push(new Portal(this.game, 900, 150));
        // World + Boundaries
        this.levelEntities[2][2][0].push(new LeftBoundary(this.game, -10, 0, 10, this.canvasHeight));
        this.levelEntities[2][2][0].push(new LeftBoundary(this.game, 392, 0, 10, this.canvasHeight));
        this.levelEntities[2][2][0].push(new LeftBoundary(this.game, 596, 235, 10, this.canvasHeight));

        this.levelEntities[2][2][0].push(new RightBoundary(this.game, 1024, 0, 10, this.canvasHeight));
        this.levelEntities[2][2][0].push(new RightBoundary(this.game, 210, 0, 10, this.canvasHeight));
        this.levelEntities[2][2][0].push(new RightBoundary(this.game, 825, 235, 10, this.canvasHeight));


        this.levelEntities[2][2][0].push(new World(this.game,0,0,2,4));
        // Reality 1
        this.levelEntities[2][2][1].push(new Widget(this.game, 3, 3));
        //Invisible Tiles
        this.levelEntities[2][2][1].push(new Tile(this.game, 342 , 616, "CITY_TILE1", true));
        this.levelEntities[2][2][1].push(new Tile(this.game, 406 , 616, "CITY_TILE1", true));
        this.levelEntities[2][2][1].push(new Tile(this.game, 470 , 616, "CITY_TILE1", true));
        this.levelEntities[2][2][1].push(new Tile(this.game, 482 , 616, "CITY_TILE1", true));
        ...
        this.levelEntities[2][2][1].push(new Waterfall(this.game, 342, 350, "green"));
        ...
        this.levelEntities[2][2][1].push(new Waterfall(this.game, 342, 450, "green"));
        this.levelEntities[2][2][1].push(new Waterfall(this.game, 342, 498, "green"));
        this.levelEntities[2][2][1].push(new Waterfall(this.game, 342, 546, "green"));
        this.levelEntities[2][2][1].push(new Waterfall(this.game, 342, 565, "green"));
        this.levelEntities[2][2][1].push(new WindBox(this.game, 230, 200, 38, 100));
        this.levelEntities[2][2][1].push(new Coin(this.game,420, 590));
        this.levelEntities[2][2][1].push(new WindBox(this.game, 600, 100, 38, 80));
        this.levelEntities[2][2][1].push(new WindBox(this.game, 750, 400, 38, 64));

        // World + Boundaries
        this.levelEntities[2][2][1].push(new LeftBoundary(this.game, -10, 0, 10, this.canvasHeight));
        this.levelEntities[2][2][1].push(new LeftBoundary(this.game, 344, 616, 10, this.canvasHeight));
        this.levelEntities[2][2][1].push(new RightBoundary(this.game, 820, 0, 10, this.canvasHeight));
        this.levelEntities[2][2][1].push(new RightBoundary(this.game, 534, 616, 10, this.canvasHeight));
         this.levelEntities[2][2][1].push(new World(this.game,0,0,2,5));
    }
